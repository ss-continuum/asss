...
\subsection{Running \asss{} in a chroot jail}
...
it drops its priviliges and runs as a normal user. To control what user
it switches to, you can use the \verb/USER/ environment variable. If you
use \verb/su/ to become root, \verb/USER/ will be set to the user who
ran \verb/su/, which should be what you want.
