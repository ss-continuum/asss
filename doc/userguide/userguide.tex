...
distinct log messages in the server. By type, there are 31 ERROR
messages, 102 WARN messages, 85 MALICIOUS messages, 64 INFO messages, and
80 DRIVEL messages.
...
private commands on the same line. There's a hard limit of five commands
on one line.
