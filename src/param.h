...
#define CFG_CONFIG_SEARCH_PATH "arenas/%a/%n:arenas/%b/%n:arenas/(default)/%n:conf/%n:%n"


/* the search path for map files */
#define CFG_LVL_SEARCH_PATH "arenas/%a/%m:arenas/%b/%m:arenas/%a.lvl:maps/%a.lvl:arenas/(default)/%m:maps/%m:%m"
#define CFG_LVZ_SEARCH_PATH "arenas/%a/%m:arenas/%b/%m:arenas/(default)/%m:maps/%m:%m"
