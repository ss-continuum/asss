...
"""
	...
	for sec, keys in docs:
		...
		print 'const struct key_help cfg_help_section_contents_%s[] =\n{' % sec
	...
	print "\n\nconst struct section_help cfg_help_sections[] =\n{"
	for s in ss:
		print s
	print '};'

	print "\nconst int cfg_help_section_count = %d;" % len(docs)

	print '\nconst char *cfg_help_all_section_names = "%s";' % \
		', '.join(secnames)
